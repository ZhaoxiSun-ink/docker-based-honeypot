...
(13, 'Remote Desktop Protocol (RDP)', '<p>Remote Desktop Protocol (RDP) is a proprietary protocol developed by Microsoft Corporation which provides a user with a graphical interface to connect to another computer over a network connection. The user employs RDP client software for this purpose, while the other computer must run RDP server software.</p>', 'rdp.jpg', '2023-11-03 00:00:00', 'Remote Desktop Protocol (RDP)'),
(14, 'Secure Shell Protocol (SSH)', '<p>The Secure Shell Protocol (SSH) is a cryptographic network protocol for operating network services securely over an unsecured network. Its most notable applications are remote login and command-line execution.</p>', 'ssh.jpg', '2023-11-05 00:00:00', 'Secure Shell Protocol (SSH)'),
